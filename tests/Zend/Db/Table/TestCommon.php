...
abstract class Zend_Db_Table_TestCommon extends Zend_Db_Table_TestSetup
{
    ...
    public function testTableInfo()
    {
        ...
        $this->assertCount(1, $info['primary']);
        $pk = array('bug_id');
    ...
    public function testTableUpdate()
    {
        ...
        $this->assertCount(1, $rowset, 'Expecting rowset count to be 1');
        $row = $rowset->current();
        $this->assertTrue(
    ...
    public function testTableDeleteWhereArray()
    {
        ...
        $this->assertCount(0, $this->_table['bugs']->find(array(1, 3)));
    }
    ...
    public function testTableFetchAllOrderExpr()
    {
        ...
        $this->assertTrue(
            $rowset instanceof Zend_Db_Table_Rowset,
            'Expecting object of type Zend_Db_Table_Rowset, got ' . get_class($rowset)
        );
        $this->assertCount(4, $rowset);
        $row1 = $rowset->current();
        $this->assertTrue(
            $row1 instanceof Zend_Db_Table_Row,
    ...
    public function testTableLoadsCustomRowClass()
    {
        ...
        $this->assertFalse(
            class_exists('My_ZendDbTable_Row_TestMyRow', false),
            'Expected TestMyRow class not to be loaded (#1)'
        );
        $this->assertFalse(
            class_exists('My_ZendDbTable_Rowset_TestMyRowset', false),
